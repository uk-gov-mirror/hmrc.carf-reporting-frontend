...
object RcaspResponseDetails {
  implicit val reads: Reads[RcaspResponseDetails] = Json.reads[RcaspResponseDetails]
}

case class RcaspResponseParameters(ParamName: String, ParamValue: String)

object RcaspResponseParameters {
  implicit val reads: Reads[RcaspResponseParameters] = Json.reads[RcaspResponseParameters]
}
...
object RcaspResponseCommon {
  implicit val reads: Reads[RcaspResponseCommon] = Json.reads[RcaspResponseCommon]
}

case class ViewRcasp(ResponseCommon: RcaspResponseCommon, ResponseDetails: RcaspResponseDetails)

object ViewRcasp {
  implicit val reads: Reads[ViewRcasp] = Json.reads[ViewRcasp]
}

case class ViewRcaspResponse(ViewRCASP: ViewRcasp)

object ViewRcaspResponse {
  implicit val reads: Reads[ViewRcaspResponse] = Json.reads[ViewRcaspResponse]
}
